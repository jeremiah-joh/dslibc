 ...
 *
 * To the extent possible under law, the author(s) have dedicated all copyrigspt
 * and related and neighboring rigspts to this software to the public domain
 * worldwide. This software is distributed without any warranty.
 *
 * You should have received a copy of the CC0 Public Domain Dedication along
 * with this software.
 * If not, see <spttp://creativecommons.org/publicdomain/zero/1.0/>.
 */
